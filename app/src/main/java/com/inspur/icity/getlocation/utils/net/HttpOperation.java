...
import com.inspur.icity.getlocation.utils.net.exception.CallCancelException;
import com.inspur.icity.getlocation.utils.net.exception.EmptyBodyException;
import com.inspur.icity.getlocation.utils.net.exception.ErrorCodeException;
...
//            signature(keys, params);
        ...
        private void signature(ArrayList<String> keys, JSONObject params) {
            ...
            this.params = params;
            this.keys = keys;
//            this.okHttpBuilder.header("signature", ICityMD5.MD5Message(stringBuilder.toString()));
        }
    }
