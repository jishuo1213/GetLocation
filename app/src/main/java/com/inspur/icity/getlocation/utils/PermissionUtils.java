...
public class PermissionUtils {
    ...
    public static boolean justCheckPermission(Activity context, String permission){
        int hasPermission = ContextCompat.checkSelfPermission(context,permission);
        if(hasPermission == PackageManager.PERMISSION_GRANTED){
            return true;
        }
    ...
    public static final boolean checkMultiPermissionResultPass(Context context, int[] grantResults, String permissionName){
